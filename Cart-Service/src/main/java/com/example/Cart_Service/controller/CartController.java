...
import com.example.common.dto.CartItemRemovalRequest;
...
public class CartController {
    ...
    @GetMapping
    public ResponseEntity<Cart> getCart(@RequestHeader("X-Authenticated-Id") String userId) {
        return ResponseEntity.ok(service.getCartByUserId(userId));
    }

    @PostMapping
    public ResponseEntity<Cart> addItem(@RequestHeader("X-Authenticated-Id") String userId,
    ...
    @DeleteMapping
    public ResponseEntity<Void> clearCart(@RequestHeader("X-Authenticated-Id") String userId) {
        service.clearCart(userId);
        return ResponseEntity.ok().build();
    }

    @PostMapping("/items/delete-ordered")
    public ResponseEntity<Void> removeOrderedItems(@RequestHeader("X-Authenticated-Id") String userId,
